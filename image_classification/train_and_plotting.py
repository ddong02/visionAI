...
# python my_train1.py -j 6 --data-path data/dataset1 --model resnet50 --device cpu --epochs 50 --opt adamw --lr 0.001 --weights ResNet50_Weights.IMAGENET1K_V1 --output-dir  data/output3